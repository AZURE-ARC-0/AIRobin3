...
def make_new_addon(description, details = None):
    ...
    use the same format as the example, The parameters the functions accepts are important, even if empty, declare the type! described as a JSON Schema object. . Here is an example of a plugin:
